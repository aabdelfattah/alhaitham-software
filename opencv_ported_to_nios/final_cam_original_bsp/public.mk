...
# CPU Name 
# setting CPU_NAME is cpu_image_processing
CPU_NAME = cpu_image_processing
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1341483308
SOPC_SYSID_FLAG += --timestamp=1341483308
ELF_PATCH_FLAG  += --timestamp 1341483308
...
# setting hal.stderr is jtag_uart_image_processing
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_image_processing

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_image_processing
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_image_processing
...
# setting hal.stdout is jtag_uart_image_processing
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_image_processing
