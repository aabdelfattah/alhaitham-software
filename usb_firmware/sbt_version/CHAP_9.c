...
//#define EP0_PACKET_SIZE    64 maged
// *************************************************************************
...
USB_DEVICE_DESCRIPTOR DeviceDescr =//<<
{
	...
	0xFF,//SWAP(0x4cc), // Vendor ID for PHILIPS
	0xFF,
	0x01,//SWAP(0x1a62),// Product ID for ISP 1362
	0x00,
	0x00,// Device Release Number 1.0
	0x01,
...
USB_CONFIGURATION_DESCRIPTOR ConfigDescr=
{
                    ...
                    0x22, //BYTE wTotalLength of data returned (include config,interface,HId & endpoint descriptors)(doesnot include the report descriptor)
	...
	0x01, //BYTE bInterfaceSubClass //report protocol
	0x02, //BYTE bInterfaceProtocol
	0x00,//BYTE iInterface
	
	9,//sizeof(struct HID descriptor), //BYTE bLength
	0x21, //BYTE bDescriptionType, assigned by USB HID discriptor
	0x10, //LSB HID specs 
...
USB_ENDPOINT_DESCRIPTOR EP_Descr =
{
	0x07,//size of ep descr.in bytes
    0x05,//USB_ENDPOINT_DESCRIPTOR_TYPE,
    0x81,//EP01, OUT
...
/*
                       ...
                       End Collection                                                                  C0 
*/
unsigned char code REPORT_DESCRIPTOR[64] =
{							
							0x05,0x01,//
							0x09,0x02,
							0xA1,0x01,
...
//mohamed maged 24-2-2012
// *************************************************************************
// USB Class device requests
// *************************************************************************

	void Chap9_GetReport(void)
	{
		printf("entering getR");
	}
	void Chap9_GetIdle(void)
	{
		printf("entering getI");
	}
	void Chap9_GetProtocol(void)
	{
		printf("entering getp");
	}

	 void Chap9_SetReport(void)
	{
		printf("entering setR");
	}
	void Chap9_SetIdle(void)
	{
		printf("entering seti \n %x",ControlData.DeviceRequest.wValue);
	}
	void Chap9_SetProtocol(void)
	{
		printf("entering setp");
	}	
//end
// *************************************************************************
