//@Abdelfattah 6/2/12 9:15 PM
//This Protocol layer handles standard USB device request, which is defined in the Chapter 9 of USB Specification Rev
//Contains Structures of string descriptors which are extra useful info but they are useless to us ?
