...
typedef struct _USB_CONFIGURATION_DESCRIPTOR {
    ...
    unsigned char bTotalLength1L;
    unsigned char bTotalLength1H;
...
typedef struct _USB_CONFIGURATION_DESCRIPTOR {
	...
	UCHAR bLengthInterface;
    UCHAR bDescriptorTypeInterface;
	...
	UCHAR bLengthHID;
    UCHAR bDescriptorTypeHID;
    UCHAR bcdHIDL;
	UCHAR bcdHIDH;
    UCHAR bCountryCode;
    UCHAR bNumDescriptor;
    UCHAR bDescriptorTypeReport;
	UCHAR wDescriptorLengthL;
	UCHAR wDescriptorLengthH;
	
	UCHAR bLengthEP;
    UCHAR bDescriptorTypeEP;
    UCHAR bEndpointAddress;
    UCHAR bmAttributes;
    UCHAR wMaxPacketSizeL;
    UCHAR wMaxPacketSizeH;
	UCHAR bInterval;
