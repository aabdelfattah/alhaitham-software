...
RESET_ADDRESS ?= 0x10480000

#-------------------------------------
# Pre-Initialized Memory Descriptions
#-------------------------------------

# Memory: mailbox_memory
MEM_0 := mailbox_memory
$(MEM_0)_NAME := mailbox_memory
...
$(MEM_0)_HIERARCHICAL_PATH := mailbox_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: mailbox_memory
mailbox_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory2_0
MEM_1 := onchip_memory2_0
...
$(MEM_1)_START := 0x10480000
$(MEM_1)_END := 0x104db99f
