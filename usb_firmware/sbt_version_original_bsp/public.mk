...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1341476950
SOPC_SYSID_FLAG += --timestamp=1341476950
ELF_PATCH_FLAG  += --timestamp 1341476950
...
# setting hal.stderr is jtag_uart_usb
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_usb

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_usb
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_usb
...
# setting hal.stdout is jtag_uart_usb
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_usb
